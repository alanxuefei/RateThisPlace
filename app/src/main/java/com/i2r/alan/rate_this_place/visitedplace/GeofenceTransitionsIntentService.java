...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    private void sendNotification(String notificationDetails) {
        ...
        builder.setSmallIcon(com.i2r.alan.rate_this_place.R.mipmap.ic_launcher)
                ...
                .setContentText(getString(com.i2r.alan.rate_this_place.R.string.geofence_transition_notification_text))
    ...
    private String getTransitionString(int transitionType) {
        switch (transitionType) {
            case Geofence.GEOFENCE_TRANSITION_ENTER:
                return getString(com.i2r.alan.rate_this_place.R.string.geofence_transition_entered);
            case Geofence.GEOFENCE_TRANSITION_EXIT:
                return getString(com.i2r.alan.rate_this_place.R.string.geofence_transition_exited);
            default:
